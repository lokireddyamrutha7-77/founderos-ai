...
import { DollarSign, TrendingDown, Clock, Wallet, Save, AlertCircle, CheckCircle2, Loader2, Printer } from "lucide-react";
  ...
  return (
    <div className="max-w-6xl mx-auto py-4 px-2 sm:px-4 print:p-0 print:max-w-none">
      ...
      <div className="hidden print:block mb-8 border-b border-gray-300 pb-4">
        <h1 className="text-3xl font-bold">FounderOS Financial Snapshot Report</h1>
        <p className="text-sm text-gray-500 mt-1">Generated by Altora Financial Analytics</p>
      </div>
